...
export default function HomeContent() {
  ...
  return (
    <div className="container">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mt-1">
                  ...
                  <span className="text-xs" style={{ color: 'var(--text-muted)' }}>The Operator Track</span>
                </div>
              </div>
            </div>

            {/* Tagline */}
            <p className="text-lg" style={{ color: 'var(--text-secondary)', maxWidth: '540px', marginBottom: '8px', lineHeight: '1.6' }}>
              Autonomous research agent that{" "}
              <span style={{ color: '#818cf8', fontWeight: 500 }}>challenges itself</span>{" "}
      ...
      {/* Footer */}
      <footer className="mt-20 pt-8" style={{ borderTop: '1px solid rgba(255,255,255,0.05)', textAlign: 'center' }}>
